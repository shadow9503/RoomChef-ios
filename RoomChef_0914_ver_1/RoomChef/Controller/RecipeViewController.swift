...
class RecipeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, RecipeQueryModelProtocol {
    ...
    var count: Int = 10
    let categoryNameList: [Int : String] = [22:"밑반찬", 23:"메인반찬", 24:"국/탕", 25:"찌개", 26:"디저트",
                                            27:"면/만두", 28:"밥/죽/떡", 29:"퓨전", 30:"김치/젓갈/장류", 31:"양념/소스/잼",
                                            32:"양식", 33:"샐러드", 34:"스프", 35:"빵", 36:"과자", 37:"차/음료/술"]
...
//        print(String(categoryNum), rLike, order, recipeSearchBar.text!, startIndex)
    ...
    // 레시피 데이터 불러오기
    func recipeListQuery(_ rCategory: Int, _ rLikeNum: Int, _ order: String, _ keyword: String?, _ startIndex: Int, _ count: Int){
        ...
        recipeQueryModel.downloadItems(rCategory: rCategory, rLikeNum: rLikeNum, order: order, keyword: keyword!, startIndex: startIndex, count: count)
    ...
    func recipeListQueryCall(){
        recipeListQuery(CATEGORYNUM, rLike, order, recipeSearchBar.text!, startIndex, count)
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationController?.setNavigationBarHidden(true, animated: false) // 네비게이션바 제거
    }
...
//        print("현재 보여지는 레시피 개수: ", stackRecipeListItems.count)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // MARK: asyn를 사용하게되면 목록에서 이미지를 제외한 다른데이터가 먼저떠서 싱크가 안맞으므로 사용안함.
        // 이미지 비동기 처리
