...
class RecipeModel: NSObject{
    ...
    // 레시피 목록데이터 모델
    init(rSeqno: String, rTitle: String, rLikeNum: String, rfThumbnailImage: String, rIntro: String, rSummary: String, rIngredient: NSDictionary, rTip: String, rDate: String, rfImagePath: NSDictionary, rfContent: NSDictionary) {
        self.rSeqno = rSeqno
        self.rTitle = rTitle
    ...
    // 레시피 상세데이터 모델
//    init(rIntro: String, rSummary: String, rIngredient: NSDictionary, rTip: String, rDate: String, rfImagePath: NSDictionary, rfContent: NSDictionary){
//        self.rIntro = rIntro
//        self.rSummary = rSummary
//        self.rIngredient = rIngredient
//        self.rTip = rTip
